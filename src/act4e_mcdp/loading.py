...
from .structures import (
    CompositeNamedDP, Connection, PrimitiveDP, DPSeries, FinitePoset, ModelFunctionality, ModelResource,
    NodeFunctionality,
...
def load_CompositeNamedDP(ob: dict):
    ...
    return CompositeNamedDP(functionalities=functionalities, resources=resources, nodes=loaded_nodes,
